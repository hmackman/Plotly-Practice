...
function buildCharts(sample) {
  ...
  d3.json(chartsURL).then(function(data) {
    ...
    var trace1 = [trace1];
    var layout = {
      title:"<b>Bacterial Clusters and Quantity Observed</b>",
      xaxis: {title:"OTU_ID (Bacterial Cluster ID)"},
      yaxis: {title: "Quantity Observed for Sample"},
      showlegend: false,
      height: 600,
      width: 1400
    };
    ...
    var layout = {
      showlegend: true,
      title: "<b>Presence of Bacterial Clusters by OTU_ID</b>"
    };
